/* data.js — loads as classic script, sets window.PD before world.js module runs */
(function () {
  'use strict';
  ...
  window.PD = {
    ...
    experience: [
      ...
      },
      {
        ...
        points: [
          ...
          'Python ETL for analytics pipelines'
        ]
      },
      {
      ...
      },
      {
        ...
        points: [
          'Python backend and database foundations',
    ...
    certifications: [
      ...
      },
      {
        ...
        issuer: 'Univ. of Michigan · Coursera',
        year:   '2022',
        col:    0x38bdf8,
